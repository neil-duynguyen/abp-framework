...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 982f9cf7-c2cf-4105-96e8-957f2eb96aff
```

> `982f9cf7-c2cf-4105-96e8-957f2eb96aff` is the password of the certificate, you can change it to any password you want.
